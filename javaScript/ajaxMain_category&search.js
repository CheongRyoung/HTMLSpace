...
function refreshCardList(obj) {
    ...
    if(obj != null) {
        ...
        categoryParam = "category_name=" + categoryName;
    }
        ...
        if(xhr.readyState==4 && xhr.status==200){
                    ...
                    sectionCol.setAttribute("class", "col");
                        ...
                        sectionColRow2.setAttribute("class", "row mt-3");
                            ...
                            sectionColRow2Col.setAttribute("class", "col");
                                ...
                                sectionColRow2ColDiv.setAttribute("class", "row row-cols-1 row-cols-md-3 g-4");
            ...
            for(var i=0; i<courseDataList.length; i++) {
                ...
                cardDiv.setAttribute("class", "col");
                    ...
                    cardh.setAttribute("id", courseDataList[i].courseVo.course_no);
                    cardh.style.cursor = "pointer";
                    cardh.setAttribute("onclick", "moveLink(this)");

                        const imgfile = document.createElement("img");
                        imgfile.setAttribute("src", "/uploadFolder2/" + courseDataList[i].imagefirst);
                        ...
                        cardb.setAttribute("class","card-body");
                            ...
                            cardbRow.setAttribute("class", "row");
                                ...
                                cardbRowCol1.setAttribute("class", "col");
                                    ...
                                    var price = courseDataList[i].courseVo.course_price.toLocaleString();
                                ...
                                cardbRowCol2.setAttribute("class", "col text-end");
                                    ...
                                    cardbRowCol2P1.setAttribute("class", "card-text");
                                        ...
                                        cardbRowCol2P1I.setAttribute("class", "bi bi-heart-fill")

                                    cardbRowCol2P1.append(cardbRowCol2P1I, " "+courseDataList[i].wishCount);
                                    ...
                                    cardbRowCol2P2.setAttribute("class", "card-text");
                                     ...
                                     cardbRowCol2P2.append(cardbRowCol2P2I, " "+courseDataList[i].courseVo.course_count);
    ...
    xhr.open("get", "./refreshMain?" + categoryParam+searchParam, true);
    xhr.send();
}
...
function searchProcess() {
    ...
    if (inputValue == "") {
        ...
        searchParam = "&searchWord=" + inputValue;
    }
    refreshCardList();
}
