...
<nav class="navbar navbar-expand-lg navbar-light bg-white" style="box-shadow: 0px 0px 3px #000808">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">B7</a>
  		 ...
  		 <ul class="navbar-nav ms-auto mb-2 mb-lg-0 d-grid">
        	...
        	<c:otherwise>
        		 <form  method="post" class="d-flex">
        			...
        			<input class="btn btn-outline-success" type="submit" value="login" formaction="/bseven/member/loginProcess">
